...
<head>
    ...
    <meta property="og:title" content="CFNKOREA">
    <meta property="og:description" content="투자코인, 이더리움 계열, erc-20계열, 탈 기반, GNC거래소, 플랫폼 기반">
    <meta property="og:image" content="http://www.cfnkorea.com/wp-content/uploads/2019/01/CFN.png">
    <meta property="og:url" content="http://www.cfnkorea.com/">
    
<link rel="icon" type="image/png" sizes="32x32" href="<?php echo get_template_directory_uri(); ?>/favi/favi-32.png"> 
<link rel="icon" type="image/png" sizes="96x96" href="<?php echo get_template_directory_uri(); ?>/favi/favi-96.png"> 
<link rel="icon" type="image/png" sizes="16x16" href="<?php echo get_template_directory_uri(); ?>/favi/favi-16.png">
<link rel="stylesheet" href="<?php echo get_template_directory_uri(); ?>/style-cfn.css">
			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="https://www.cfnkorea.co.kr/wp-content/uploads/2019/01/CFN.png" alt="<?php echo esc_attr( get_bloginfo( 'name' ) ); ?>" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
						<span>DH Blockchain</span>
					</a>
				</div>
			<?php
